...
```{r identify matches between ipcc refs and our database}
...
#ipccBibUnique <- ipccBibUnique[!is.na(ipccBibUnique$year),]
ipccBibUnique <- ipccBibUnique[which((min(years, na.rm=T) <= ipccBibUnique$year) | 
                                       is.na(ipccBibUnique$year)),]
nrow(ipccBibUnique) # 29963
