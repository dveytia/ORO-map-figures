...
fig3_ggp <- ggplot(typeMethodDf, aes(x=order, y=method_percent))+
  ...
  geom_text(data = oroTotals, aes(x=order,label = scales::number(oroTotal, big.mark = ",")), y=105, size=3, col="black", inherit.aes = FALSE)+ 
  geom_text(data = percentEmpirical, aes(x=order,label = paste0(percentEmpirical,"%")), 
